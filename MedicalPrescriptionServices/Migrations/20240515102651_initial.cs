    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrescriptionAnalytics", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PrescriptionAnalytics_DrugInteraction_DrugInteractionId",
                        column: x => x.DrugInteractionId,
                        principalTable: "DrugInteraction",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PrescriptionAnalytics_Patient_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patient",
                        principalColumn: "PatientId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrescriptionValidation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PrescriptionValidation_Prescription_PrescriptionId",
                        column: x => x.PrescriptionId,
                        principalTable: "Prescription",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PrescriptionValidation_Specialist_SpecialistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrescriptionAnalytics_DrugInteractionId",
                table: "PrescriptionAnalytics",
                column: "DrugInteractionId");

            migrationBuilder.CreateIndex(
                name: "IX_PrescriptionAnalytics_PatientId",
                table: "PrescriptionAnalytics",
                column: "PatientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrescriptionValidation_PrescriptionId",
                table: "PrescriptionValidation",
                column: "PrescriptionId");

            migrationBuilder.CreateIndex(
                name: "IX_PrescriptionValidation_SpecialistId",
                table: "PrescriptionValidation",
                column: "SpecialistId");
        }
